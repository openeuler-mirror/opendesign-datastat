...
import chevronsCown from '~icons/app/chevrons-down';
  ...
  <o-banner class="home-banner">
    <div class="banner-content">
      ...
      <div class="more" @click="goContributors">
        <p>{{ t('home.moreData') }}</p>
        <o-icon class="icon"><chevrons-cown></chevrons-cown></o-icon>
      </div>
    </div>
    <template #video>
      <video
        class="bg-video"
        src="https://datastat.obs.cn-north-4.myhuaweicloud.com/datastat-opengauss-home.mp4"
        :poster="homeBanner"
        autoplay
        loop
        muted
...
.banner-content {
  ...
  .more {
    ...
    .icon {
      animation: loadingtd 2s infinite ease-in-out;
      display: inline-block;
    }
  }
}
