      ...
      <div class="about-data-content">
        ...
        <div v-if="language === 'zh'" class="info">
          ...
          <p class="text">
            ...
            鉴于<a href="https://opengauss.org">https://opengauss.org</a
            >提供的部分服务属于电子公告牌（BBS）服务，<a
              href="https://opengauss.org"
              >https://opengauss.org</a
            >上关于其会员或其会员发布的相关信息（包括但不限于用户名称、公司名称、
            联系人及联络信息，相关图片、视讯等）的信息均是由会员自行提供，会员依法应对其提供的任何信息承担全部责任。
            任何企业或个人认为<a href="https://opengauss.org"
              >https://opengauss.org</a
            >网页内容（包括但不限于<a href="https://opengauss.org"
              >https://opengauss.org</a
            >会员发布的商品信息）可能涉嫌侵犯其合法权益，应该及时向openGauss社区<a
              href="mailto:contact@opengauss.org"
              >contact@opengauss.org</a
            >提出书面权利通知，并提供身份证明、权属证明、具体链接（URL）及详细侵权情况证明。openGauss社区在收到上述法律文件后，将会依法尽快移除相关涉嫌侵权的内容。
          </p>
        </div>
        <div v-else class="info">
          ...
          <p class="text">
            ...
            <a href="mailto:contact@opengauss.org">contact@opengauss.org</a> in
