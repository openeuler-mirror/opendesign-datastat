...
import arrowDown from '~icons/shared/chevrons-down';
...
watch(isScrollDown, () => {
  if (isScrollDown.value) {
    router.push({ name: 'detail', params: { lang: locale.value } });
  }
});
  ...
  <o-banner class="home-banner">
    <div class="banner-content">
      ...
      <div class="more" @click="goContributors">
        <p>{{ t('common.home.moreData') }}</p>
        <OIcon class="icon"><arrow-down></arrow-down></OIcon>
      </div>
    </div>
    <template #video>
      <video
        class="bg-video"
        src="https://datastat.obs.cn-north-4.myhuaweicloud.com/datastat-openubmc-home.mp4"
        :poster="homeBanner"
        autoplay
        loop
        muted
