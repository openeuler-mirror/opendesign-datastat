          ...
          <div class="ranking-list">
            <div class="ranking-list-item">
              ...
              <el-table v-loading="loading" :data="highRanking" style="width: 100%">
                ...
                <el-table-column prop="user_login" align="left" label="AtomGit ID" show-overflow-tooltip width="180"
            ...
            <div class="ranking-list-item">
              ...
              <el-table v-loading="loading" :data="lowRanking" style="width: 100%">
                ...
                <el-table-column prop="user_login" align="left" show-overflow-tooltip label="AtomGit ID" width="180"
                  ><template #default="scope">
                    <div>
                      <span
                        :style="{
